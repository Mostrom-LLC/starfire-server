...
import { AgentFlowNodeConfiguration, AgentKnowledgeBase, AgentKnowledgeBaseSummary, AgentStatus, AgentVersion, AgentVersionSummary, CollectorFlowNodeConfiguration, ConditionFlowNodeConfiguration, FlowConnection, FlowNodeInput, FlowNodeOutput, FlowNodeType, FlowStatus, FlowValidation, IngestionJobStatistics, InlineCodeFlowNodeConfiguration, InputFlowNodeConfiguration, IteratorFlowNodeConfiguration, KnowledgeBaseFlowNodeConfiguration, KnowledgeBaseState, LambdaFunctionFlowNodeConfiguration, LexFlowNodeConfiguration, LoopControllerFlowNodeConfiguration, LoopInputFlowNodeConfiguration, OutputFlowNodeConfiguration, PromptFlowNodeConfiguration, PromptInferenceConfiguration, PromptTemplateConfiguration, PromptTemplateType, RetrievalFlowNodeConfiguration, S3Location, StorageFlowNodeConfiguration } from "./models_0";
/**
 * @public
 * @enum
 */
 ...
 * @public
 */
export type RedshiftProvisionedAuthType = (typeof RedshiftProvisionedAuthType)[keyof typeof RedshiftProvisionedAuthType];
/**
 ...
 * @public
 */
export type RedshiftQueryEngineStorageType = (typeof RedshiftQueryEngineStorageType)[keyof typeof RedshiftQueryEngineStorageType];
/**
 ...
 * @public
 */
export type SupplementalDataStorageLocationType = (typeof SupplementalDataStorageLocationType)[keyof typeof SupplementalDataStorageLocationType];
/**
 ...
 * @public
 */
export type FlowNodeConfiguration = FlowNodeConfiguration.AgentMember | FlowNodeConfiguration.CollectorMember | FlowNodeConfiguration.ConditionMember | FlowNodeConfiguration.InlineCodeMember | FlowNodeConfiguration.InputMember | FlowNodeConfiguration.IteratorMember | FlowNodeConfiguration.KnowledgeBaseMember | FlowNodeConfiguration.LambdaFunctionMember | FlowNodeConfiguration.LexMember | FlowNodeConfiguration.LoopMember | FlowNodeConfiguration.LoopControllerMember | FlowNodeConfiguration.LoopInputMember | FlowNodeConfiguration.OutputMember | FlowNodeConfiguration.PromptMember | FlowNodeConfiguration.RetrievalMember | FlowNodeConfiguration.StorageMember | FlowNodeConfiguration.$UnknownMember;
/**
 * @public
 */
export declare namespace FlowNodeConfiguration {
     ...
     * @public
     */
    interface LoopControllerMember {
        input?: never;
        output?: never;
        knowledgeBase?: never;
        condition?: never;
 ...
 * @internal
 */
export declare const TextContentDocFilterSensitiveLog: (obj: TextContentDoc) => any;
/**
 * @internal
 */
export declare const InlineContentFilterSensitiveLog: (obj: InlineContent) => any;
/**
 * @internal
 */
export declare const CustomContentFilterSensitiveLog: (obj: CustomContent) => any;
/**
 * @internal
 */
export declare const DocumentContentFilterSensitiveLog: (obj: DocumentContent) => any;
/**
 * @internal
 */
export declare const MetadataAttributeValueFilterSensitiveLog: (obj: MetadataAttributeValue) => any;
/**
 * @internal
 */
export declare const MetadataAttributeFilterSensitiveLog: (obj: MetadataAttribute) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const KnowledgeBaseDocumentFilterSensitiveLog: (obj: KnowledgeBaseDocument) => any;
/**
 * @internal
 */
export declare const IngestKnowledgeBaseDocumentsRequestFilterSensitiveLog: (obj: IngestKnowledgeBaseDocumentsRequest) => any;
/**
 * @internal
 */
export declare const QueryGenerationContextFilterSensitiveLog: (obj: QueryGenerationContext) => any;
/**
 * @internal
 */
export declare const QueryGenerationConfigurationFilterSensitiveLog: (obj: QueryGenerationConfiguration) => any;
/**
 * @internal
 */
export declare const RedshiftConfigurationFilterSensitiveLog: (obj: RedshiftConfiguration) => any;
/**
 * @internal
 */
export declare const SqlKnowledgeBaseConfigurationFilterSensitiveLog: (obj: SqlKnowledgeBaseConfiguration) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const NeptuneAnalyticsConfigurationFilterSensitiveLog: (obj: NeptuneAnalyticsConfiguration) => any;
/**
 * @internal
 */
export declare const OpenSearchManagedClusterConfigurationFilterSensitiveLog: (obj: OpenSearchManagedClusterConfiguration) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const UpdateKnowledgeBaseRequestFilterSensitiveLog: (obj: UpdateKnowledgeBaseRequest) => any;
/**
 * @internal
 */
export declare const UpdateKnowledgeBaseResponseFilterSensitiveLog: (obj: UpdateKnowledgeBaseResponse) => any;
/**
 * @internal
 */
export declare const PromptAgentResourceFilterSensitiveLog: (obj: PromptAgentResource) => any;
/**
 * @internal
 */
export declare const PromptGenAiResourceFilterSensitiveLog: (obj: PromptGenAiResource) => any;
/**
 * @internal
 */
export declare const PromptMetadataEntryFilterSensitiveLog: (obj: PromptMetadataEntry) => any;
/**
 * @internal
 */
export declare const PromptVariantFilterSensitiveLog: (obj: PromptVariant) => any;
/**
 * @internal
 */
export declare const CreatePromptRequestFilterSensitiveLog: (obj: CreatePromptRequest) => any;
/**
 * @internal
 */
export declare const CreatePromptResponseFilterSensitiveLog: (obj: CreatePromptResponse) => any;
/**
 * @internal
 */
export declare const CreatePromptVersionResponseFilterSensitiveLog: (obj: CreatePromptVersionResponse) => any;
/**
 * @internal
 */
export declare const GetPromptResponseFilterSensitiveLog: (obj: GetPromptResponse) => any;
/**
 * @internal
 */
export declare const UpdatePromptRequestFilterSensitiveLog: (obj: UpdatePromptRequest) => any;
/**
 * @internal
 */
export declare const UpdatePromptResponseFilterSensitiveLog: (obj: UpdatePromptResponse) => any;
/**
 * @internal
 */
export declare const ValidateFlowDefinitionResponseFilterSensitiveLog: (obj: ValidateFlowDefinitionResponse) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const FlowNodeConfigurationFilterSensitiveLog: (obj: FlowNodeConfiguration) => any;
/**
 * @internal
 */
export declare const LoopFlowNodeConfigurationFilterSensitiveLog: (obj: LoopFlowNodeConfiguration) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const CreateFlowVersionResponseFilterSensitiveLog: (obj: CreateFlowVersionResponse) => any;
/**
 * @internal
 */
export declare const GetFlowResponseFilterSensitiveLog: (obj: GetFlowResponse) => any;
/**
 * @internal
 */
export declare const GetFlowVersionResponseFilterSensitiveLog: (obj: GetFlowVersionResponse) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const ValidateFlowDefinitionRequestFilterSensitiveLog: (obj: ValidateFlowDefinitionRequest) => any;
